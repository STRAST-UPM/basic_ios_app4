...
class LibraryManager: NSObject, ObservableObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func callLibraryFunction() {
        let libraries = ["Capacitor", "FBSDKLoginKit", "FBSDKShareKit", "FBAEMKit", "FirebaseAuth", "FirebaseCrashlytics"]
    ...
    private func callCapacitor() {
        print("⚡ Capacitor ha sido llamado correctamente.")
    }
